    ...
    >
      ...
      >
        ...
        <div className="mt-4 md:mt-2 lg:mt-4 flex flex-row justify-between items-end">
          ...
          <Link href={`/events/${id}`} className="font-normal text-base md:text-base lg:text-xl px-4 py-2 rounded-2xl bg-black text-white border-white border-rounded-xl lg:border-rounded-3xl border-[1px]">
            View Details
          </Link>
        </div>
      </div>
