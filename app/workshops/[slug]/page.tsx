...
import Form from "../(WorkshopComponents)/Form";

type Props = {};

async function page({ params }: { params: { slug: string } }) {
  const query = `*[_type == "workshop" && slug.current == $slug]`;
  const { slug } = params;
  console.log(slug);
      ...
      <div className="bg-white  h-max pb-8 md:pb-8 lg:pb-16 w-full rounded-b-[60px]">
        ...
        <div className="mt-2 md:mt-4 lg:mt-8 w-full lg:w-[90%] lg:flex lg:flex-row lg:justify-between lg:mx-auto ">
          ...
          <div className="mt-2 md:mt-4 lg:mt-0 relative md:w-[90%] w-[95%] mx-auto  xl:h-[67vh] md:h-max h-[50vh]  lg:w-[38%] px-4 py-4 rounded-2xl md:rounded-xl lg:rounded-3xl bg-black text-white">
            ...
            <Link href="#form" className=" border-white border-2 mt-4 md:mt-4 lg:mt-4 w-[95%] text-base md:text-lg lg:text-xl mx-auto bg-[#ED1F04] h-[5vh] rounded-2xl md:rounded-2xl lg:rounded-3xl lg:h-[6vh] flex items-center justify-center">
              Book Now
            </Link>
          </div>
        </div>
